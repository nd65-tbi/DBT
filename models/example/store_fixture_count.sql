...
SELECT
    ...
    CASE 
        ...
        WHEN FIXTURE_NAME IN (
            'BELT_WALL', 'FLEX_WALL', 'SOCKS_WALL', 'PERIMETER_JETRAIL',
            'SLAT_WALL', 'SPORTSWEAR_WALL_SPACE', 'BACKROOM_BAR_RACK',
            'REEVES_WALL_DOUBLE_HANGING_PARTIAL', 'PAIDGOOD_HANGBAR_JETRAIL',
            'BACKROOM_HANGBAR_JETRAIL', 'RENTAL_HANGBAR_JETRAIL',
            'BACKROOM_SHELVING', 'BACKROOM_SUPPLY_SHELVING',
            'REEVES_WALL_DOUBLE_HANGING', 'UNDERWEAR_WALL'
        ) THEN 'Feet'
        ELSE 'Count'
...
UNPIVOT (
    FIXTURE_COUNT FOR FIXTURE_NAME IN (
        "ACCESSORY_FIXTURE",
